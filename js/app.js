...
checkBoxBlue.addEventListener('change', function(){   
    this.checked ? incrementColor(inputBlue) : clearInterval(timer);
});
checkBoxGreen.addEventListener('change', function(){   
    this.checked ? incrementColor(inputGreen) : clearInterval(timer);
});

checkBoxRed.addEventListener('change', function(){   
        this.checked ? incrementColor(inputRed) : clearInterval(timer);
});
